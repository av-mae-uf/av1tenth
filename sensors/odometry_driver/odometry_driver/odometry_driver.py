...
def main(args=None):
    ...
    odometry_driver = OdometryDriver()
    try:
        rclpy.spin(odometry_driver)
    except KeyboardInterrupt:
        pass
    finally:
        odometry_driver.serial_encoder.serial_close()
        odometry_driver.serial_imu.serial_close()
        odometry_driver.destroy_node()
        rclpy.shutdown()
